...
import { reviewCreate } from "@/services/Review";
...
const CreateReview = () => {
  ...
  const handleSubmitReviewComment = async () => {
    ...
    try {
      const res = await reviewCreate(modifiedData);
      if (res?.success) {
  ...
  // Handle User Redirect for Review
  ...
  return (
    <>
      <Button className="dark:text-white" onClick={() => setIsOpen(true)}>Write Review</Button>
      <MyModal
        isOpen={isOpen}
          ...
          <div className="flex flex-col max-w-xl p-4 rounded-xl lg:p-12 ">
            <div className="flex flex-col items-center w-full">
              ...
              <div className="flex flex-col w-full space-y-2">
                ...
                />
                <Button className="dark:text-white" onClick={handleSubmitReviewComment}>Submit</Button>
              </div>
            </div>
